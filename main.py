...
def parser() -> argparse.Namespace:
    """
    Получает значения из аргументов командной строки.
    ...
    parser.add_argument("num_images", type=int, help="Число изображений")
    args = parser.parse_args()

    return args


def download_images(keyword: str, download_folder: str, num_images: int) -> List[str]:
    """
...
def main():
    ...
    image_paths = download_images(keyword, download_folder, num_images)
